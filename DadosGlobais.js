...
const Porcentagem = ((PessoasConectadas/PessoasMundo)*100).toFixed(2)
    ...
    paragrafo.innerHTML = `você sabia que o mundo tem <span> ${PessoasMundo} bilhoẽs </span>  de pessoas e que aproximadamente
     <span> ${PessoasConectadas} bilhoẽs </span>  estão conectadas em 
